...
class Leadwidget extends StatelessWidget {
  const Leadwidget({super.key, required this.name, required this.phone, required this.email});
          ...
          children: [
            Row(
              children: [
                ...
                Text("Update Lead", style: TextStyle(color: Colors.grey.shade700, fontSize: 15)),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("Delete Lead", style: TextStyle(color: Colors.red, fontSize: 15),),
              ],
            )
          ],
        ),
